 ...
 * @example <col-circle-progress active-color="#2979ff" :percent="80"></col-circle-progress>
 */
import guid from '../../core/function/guid'
import color from '../../core/function/color'

export default {
  name: 'col-circle-progress',
  props: {
    // 圆环进度百分比值
    percent: {
      type: Number,
  ...
  methods: {
    ...
    drawCircleByProgress(progress) {
      ...
      if (this.circleColor) ctx.setStrokeStyle(this.circleColor)
