<template>
  <view class="col-swipeout-wrap" :style="{ backgroundColor: backgroundColor }">
    <view
      class="col-swipeout-item"
    ...
    >
      <view class="col-swipeout-content">
        <slot name="content"></slot>
      </view>
      <view class="col-swipeout-button-right-group" v-if="actions.length > 0" @touchend.stop="loop">
        <view
          class="col-swipeout-button-right-item"
      ...
      <view
        class="col-swipeout-button-right-group"
        @touchend.stop="loop"
...
.col-swipeout-content {
  white-space: nowrap;
  overflow: hidden;
}

.col-swipeout-button-right-group {
  position: absolute;
  right: -100%;
  top: 0;
  height: 100%;
...
.col-swipeout-button-right-item {
  height: 100%;
  float: left;
  white-space: nowrap;
  box-sizing: border-box;
