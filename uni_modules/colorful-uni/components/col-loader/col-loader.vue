<template>
  <view
    v-if="show"
    class="col-loader"
    :class="mode == 'circle' ? 'col-loader-circle' : 'col-loader-flower'"
    :style="[cricleStyle]"
  >
  </view>
</template>
 ...
 * @example <col-loader mode="circle"></col-loader>
 */
export default {
  name: 'col-loader',
  props: {
...
.col-loader-circle {
  ...
  animation: col-circle 1s linear infinite;
}
...
.col-loader-flower {
  ...
  animation: col-flower 1s steps(12) infinite;
