<template>
  <view class="au-swipeout-wrap" :style="{ backgroundColor: backgroundColor }">
    <view
      class="au-swipeout-item"
    ...
    >
      <view class="au-swipeout-content">
        <slot name="content"></slot>
      </view>
      <view class="au-swipeout-button-right-group" v-if="actions.length > 0" @touchend.stop="loop">
        <view
          class="au-swipeout-button-right-item"
      ...
      <view
        class="au-swipeout-button-right-group"
        @touchend.stop="loop"
...
.au-swipeout-button-right-group {
  position: absolute;
  right: -100%;
  top: 0;
  height: 100%;
